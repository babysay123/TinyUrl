...
<template>
  <section>
    ...
    <LoginInput
      style="margin-top: 6px; background: #fff;"
      v-model="input[referrerConfig.model]"
      :icon="referrerConfig.icon"
      :placeholder="referrerConfig.placeholder"
      :inputType="referrerConfig.inputType"
      :maxLength="referrerConfig.maxLength"
      :minLength="referrerConfig.minLength"
    />
...
import { registerApi } from 'Plugins/api'
import {
  usernameValid,
  passwordValid,
  repeatPwdValid,
