  ...
  <section class="send-hbbg send-hbbg2">
    ...
    <section class="send-hbbg-box dInV">
      <div class="beeting-look-title">
        ...
        <span class="beeting-look-close" @click="close">&times;</span>
      </div>
      <ul class="fw w100">
...
<style lang="scss" scoped>
  .send-hbbg {position:fixed;top:0;z-index:1001;max-width:780px;margin:0 auto;width:100%;height:100%;background:rgba(0, 0, 0, .6);}
  ...
  .send-hbbg-box .beeting-look-title {background:#F6F6F6; color:#333; position: relative; line-height: 28px;}
  .send-hbbg-box .beeting-look-title span {font-size: 13px;}
  .send-hbbg-box .beeting-look-title .beeting-look-close {position: absolute; right: 6px; font-size: 24px;}
